...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 30, 2025 at 10:58 AM
...
(2, '123456789', 'Intel i5 6th generation', 'Latest CPU in this year', 1, 1, 3000.00, 5000.00, 107, 3, '2025-09-28 02:53:13', '2025-09-30 08:48:13'),
(3, '245622135', 'Amd A8 7500k', 'The best seller in AMD', 1, 2, 3000.00, 8000.00, 110, 5, '2025-09-28 02:53:13', '2025-09-30 08:53:34'),
...
(30, 'PO-25-09-7085', 1, 30000.00, 'Cancelled', '2025-09-24 10:32:06', 1, 0),
(31, 'PO-25-09-9277', 2, 15000.00, 'Ordered', '2025-09-24 10:42:33', 1, 1),
(32, 'PO-25-09-5033', 1, 3000.00, 'Cancelled', '2025-09-24 10:45:08', 1, 0),
(33, 'PO-25-09-4479', 2, 3000.00, 'Cancelled', '2025-09-24 10:45:14', 1, 0),
(35, 'PO-25-09-2183', 4, 30000.00, 'Received', '2025-09-27 18:33:42', 2, 1),
(36, 'PO-25-09-4367', 4, 5000.00, 'Cancelled', '2025-09-27 18:42:01', 2, 1),
(37, 'PO-25-09-5019', 5, 900000.00, 'Received', '2025-09-30 01:47:36', 2, 1);
...
(45, 37, 2, 100, 3000.00, 300000.00),
(46, 37, 3, 200, 3000.00, 600000.00);
...
(9, 'TXN-2509-1258', 'Walk-in', 24000.00, 24000.00, 0.00, '2025-09-30 01:45:08', 2),
(10, 'TXN-2509-5936', 'Walk-in', 800000.00, 800000.00, 0.00, '2025-09-30 01:53:34', 2);
...
(11, 9, 3, 3, 8000.00, 24000.00, '2025-09-30 08:45:08'),
(12, 10, 3, 100, 8000.00, 800000.00, '2025-09-30 08:53:34');
...
--
ALTER TABLE `item_stock_adjustment`
  MODIFY `item_stock_adjustment_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `purchase_orders`
--
ALTER TABLE `purchase_orders`
  MODIFY `purchase_order_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;

--
-- AUTO_INCREMENT for table `purchase_order_items`
--
ALTER TABLE `purchase_order_items`
  MODIFY `purchase_order_item_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
