...
$pageHeight = 40 + $itemsHeight + 35 + 30; // Increased footer from 25 to 30
...
class ReceiptPDF extends FPDF
{
    ...
    function Footer()
    {
        ...
        $this->Cell($this->w, 3.5, "THANK YOU!", 0, 1, 'C');
        $this->SetFont('Courier', '', 8);
        $this->Cell($this->w, 3, "Please come again", 0, 1, 'C');
    }
