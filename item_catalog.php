              ...
              <?php foreach ($items as $item): ?>
                ...
                <tr>
                  ...
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                    <p>Cost: <span class="text-sm text-gray-800">₱<?php echo number_format($item['cost_price']); ?></span>
                    </p>
                    <p>Sell: <span
                        class="text-gray-900 font-medium">₱<?php echo number_format($item['selling_price']); ?></span></p>
                  </td>
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                  ...
                  <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                    <div class="flex space-x-2">
                      <button class="text-green-400 hover:text-green-600 openEditProductModal"
                        data-id="<?= $item['item_id'] ?>" data-name="<?= htmlspecialchars($item['item_name']) ?>"
                        data-barcode="<?= htmlspecialchars($item['barcode']) ?>"
                        data-description="<?= htmlspecialchars($item['description'] ?? '') ?>"
                        data-category="<?= $item['category_id'] ?>" data-supplier="<?= $item['supplier_id'] ?>"
                        data-cost="<?= $item['cost_price'] ?>" data-sell="<?= $item['selling_price'] ?>"
                        data-qty="<?= $item['quantity'] ?>" data-min="<?= $item['min_stock'] ?>">
